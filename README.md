...
Я&nbsp;не&nbsp;останавливаюсь на&nbsp;достигнутом, и:

- [x] В 2022 году окончил обучение, успешно защитив диплом, в&nbsp;[Яндекс.Практикуме](https://practicum.yandex.ru/web/ "Сервис онлайн-образования от Яндекса") по&nbsp;направлению **&laquo;Фронтенд-разработчик&raquo;** (10-ти месячная учебная программа).

- [ ] В&nbsp;данный момент завершаю (пишу ВКР) обучение [в&nbsp;крупнейшем вузе Санкт-Петербурга](https://www.spbstu.ru/ "&laquo;Политех&raquo;") по&nbsp;профессии **&laquo;Веб-разработчик. Язык PHP&raquo;** (10-ти месячная программа профессиональной переподготовки).

- [ ] Сейчас прохожу обучение в **&laquo;Skillbox&raquo;** на курсе **&laquo;PHP-разработчик&raquo;** (7-ми месячная программа).

- [ ] Регулярно просматриваю различные учебные видео ролики связанные с IT, а также читаю статьи/советы/лайфхаки связанные с программированием и веб разработкой.

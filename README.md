...
- [x] В июне 2022 году окончил обучение, успешно защитив диплом, в&nbsp;[Яндекс.Практикуме](https://practicum.yandex.ru/web/ "Сервис онлайн-образования от Яндекса") по&nbsp;направлению **&laquo;Фронтенд-разработчик / React&raquo;** (10-ти месячная учебная программа).

- [x] В октябре 2022 года закончил обучение [в&nbsp;крупнейшем вузе Санкт-Петербурга](https://www.spbstu.ru/ "&laquo;Политех&raquo;") по&nbsp;профессии **&laquo;Веб-разработчик. Язык PHP / Laravel&raquo;** (10-ти месячная программа профессиональной переподготовки).

- [ ] В данный момент заканчиваю обучение в **&laquo;Skillbox&raquo;** на курсе **&laquo;PHP-разработчик / Symfony&raquo;** (7-ми месячная программа).
